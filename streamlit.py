...
if page == pages[0]:
    ...
    # Interface utilisateur pour choisir le classifieur et la métrique
    classifier_choice = st.selectbox("Choisir un classifieur", ['Random Forest', 'SVC', 'Logistic Regression'])
    metric_choice = st.selectbox("Choisir une métrique", ['Accuracy', 'Confusion matrix'])
    
    clf = prediction(classifier_choice)
